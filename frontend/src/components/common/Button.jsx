...
const Button = ({
  ...
  const variants = {
    ...
    outline:
      'border border-gray-300 bg-white text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:ring-blue-500 ' +
      'dark:border-gray-600 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800 dark:hover:text-white',
